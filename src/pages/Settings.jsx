...
cd ~/Desktop/my-inner-family && git add . && git commit -m "fix: settings page build error" && git push
  ...
  return (
    <div className="page-content" style={{ padding: '48px 24px 120px' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-soft)', marginBottom: 14, lineHeight: 1.5 }}>Choose what you are working on — your journal prompts will reflect this.</p>
